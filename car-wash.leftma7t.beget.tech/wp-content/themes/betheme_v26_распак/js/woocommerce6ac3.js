...
$( document.body ).on( 'added_to_cart', function( e ) {
  ...
  function getUrlWithoutPagination(){
    ...
    if(current_url.includes("page/index.html")){
        url = current_url.split("page/index.html")[0];
    }else{
        url = current_url;
    }
  ...
  var productvariations = {
    ...
    triggerChange: function(atr, nval) {
        ...
        if( $('.mfn-vr-select option').length )
            $('.mfn-vr-select option').css('display', 'none');
        ...
        $('.woocommerce div.product form.cart .variations select option').each(function() {
            ...
            if($('.woocommerce .mfn-variations-wrapper .mfn-vr select.'+attr_name).length)
                $('.woocommerce .mfn-variations-wrapper .mfn-vr select.'+attr_name+' option[value="'+val+'"]').css('display', 'block');
        });
